        ...
        <header className="flex shrink-0 items-center justify-between border-b-4 border-amber-500 bg-[#000075] px-4 py-3 text-white sm:px-6">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[11px] text-blue-200">{request.section} • {request.requestedStartTime} - {request.requestedEndTime} • {request.id}</p>
            </div>
          </div>
          <button type="button" onClick={onClose} className="rounded p-1.5 text-blue-200 hover:bg-white/10 hover:text-white" title="Close affected train details" aria-label="Close"><X className="h-5 w-5" /></button>
        </header>
